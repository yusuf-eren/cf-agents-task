/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3a676503c0c0ebd8fd6ab5059665c76b)
// Runtime types generated with workerd@1.20250803.0 2025-03-14 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OPENAI_API_KEY: string;
		GATEWAY_BASE_URL: string;
		DATABASE_URL: string;
		RouterAgent: DurableObjectNamespace<import("./src/server").RouterAgent>;
		CampaignAgent: DurableObjectNamespace<import("./src/server").CampaignAgent>;
